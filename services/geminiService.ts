        ...
        responseSchema: {
          ...
          properties: {
            altText: {
              type: Type.STRING,
              description:
                "A concise and descriptive alt text for accessibility. It should not include phrases like 'image of' or 'picture of'.",
            },
            title: {
              type: Type.STRING,
              description:
                "A short, engaging title for the image as a plain sentence (e.g., 'A busy day in London'). This should be different from the alt text and not contain underscores or dashes.",
            },
          },
