...
export const ImageList: React.FC<ImageListProps> = ({ images, selectedImageId, onSelectImage, onAddImages }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-gray-900/50 p-3 rounded-xl space-y-3">
        <h2 className="text-lg font-semibold text-center text-gray-200 mb-1">Your Images</h2>
        <div className="flex-grow overflow-y-auto space-y-2 pr-1">
            ...
            <button
                ...
                selectedImageId === image.id ? 'bg-indigo-600/50' : 'hover:bg-gray-700'
                }`}
            >
                ...
                <p className="flex-grow text-sm text-gray-200 truncate pr-2">{image.title}</p>
            </button>
            ))}
        </div>
        <button
